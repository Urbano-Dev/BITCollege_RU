...
[System.ServiceModel.ServiceContractAttribute(ConfigurationName="ICollegeRegistration")]
public interface ICollegeRegistration
{
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICollegeRegistration/RegistrationCourse", ReplyAction="http://tempuri.org/ICollegeRegistration/RegistrationCourseResponse")]
    int RegistrationCourse(int studentId, int courseId, string notes);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICollegeRegistration/RegistrationCourse", ReplyAction="http://tempuri.org/ICollegeRegistration/RegistrationCourseResponse")]
    System.Threading.Tasks.Task<int> RegistrationCourseAsync(int studentId, int courseId, string notes);
...
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public interface ICollegeRegistrationChannel : ICollegeRegistration, System.ServiceModel.IClientChannel
{
}

[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public partial class CollegeRegistrationClient : System.ServiceModel.ClientBase<ICollegeRegistration>, ICollegeRegistration
{
    ...
    public int RegistrationCourse(int studentId, int courseId, string notes)
    {
        return base.Channel.RegistrationCourse(studentId, courseId, notes);
    }
    
    public System.Threading.Tasks.Task<int> RegistrationCourseAsync(int studentId, int courseId, string notes)
    {
        return base.Channel.RegistrationCourseAsync(studentId, courseId, notes);
    }
