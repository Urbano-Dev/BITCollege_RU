...
namespace BITCollege_RU.Controllers
{
    public class SuspendedStatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GradePointStateId,LowerLimit,UpperLimit,TuitionFactor")] SuspendedState suspendedState)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GradePointStateId,LowerLimit,UpperLimit,TuitionFactor")] SuspendedState suspendedState)
        {
            if (ModelState.IsValid)
            {
