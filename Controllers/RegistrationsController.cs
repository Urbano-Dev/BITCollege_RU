...
namespace BITCollege_RU.Controllers
{
    public class RegistrationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RegistrationId,StudentId,CourseId,RegistraionNumber,RegistrationDate,Grade,Notes")] Registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RegistrationId,StudentId,CourseId,RegistraionNumber,RegistrationDate,Grade,Notes")] Registration registration)
        {
            if (ModelState.IsValid)
            {
