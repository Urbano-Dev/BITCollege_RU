...
namespace BITCollege_RU.Controllers
{
    public class HonoursStatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GradePointStateId,LowerLimit,UpperLimit,TuitionFactor")] HonoursState honoursState)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GradePointStateId,LowerLimit,UpperLimit,TuitionFactor")] HonoursState honoursState)
        {
            if (ModelState.IsValid)
            {
