...
namespace BITCollege_RU.Controllers
{
    public class RegularStatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GradePointStateId,LowerLimit,UpperLimit,TuitionFactor")] RegularState regularState)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GradePointStateId,LowerLimit,UpperLimit,TuitionFactor")] RegularState regularState)
        {
            if (ModelState.IsValid)
            {
