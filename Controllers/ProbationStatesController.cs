...
namespace BITCollege_RU.Controllers
{
    public class ProbationStatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GradePointStateId,LowerLimit,UpperLimit,TuitionFactor")] ProbationState probationState)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GradePointStateId,LowerLimit,UpperLimit,TuitionFactor")] ProbationState probationState)
        {
            if (ModelState.IsValid)
            {
